export const empireStrikesBack = `Echo Three to Echo Seven.
...
Might I-- Do you know where Commander Skywalker is?
...
Still no-- Still no contact from Skywalker or Solo.
...
We picked up something outside Zone 1 2 moving east.
...
Send Rogues 1 0 and 1 1 to Station 38.
...
If we followed up every lead -- But, sir, the Hoth system is supposed to be devoid of humans forms.
...
Sir, it will take quite a while to evacuate the T-4 7 s.
...
The fleet has moved out of light speed, and we're preparing to -- You have failed me for the last time, Admiral.
...
The ion cannon will fire several sh*ts ... to make sure that any enemy ships will be out of your flight path.
...
All troops will debark for ground as*ault.
...
Imperial troops have entered -- Come on.
...
Sir, might I suggest that you -- It can wait.
...
- Sir, might I suggest -- - Shut him up or shut him down!
...
Are you all right? Come on. You were lucky to get out of there.
...
Our ships have sighted the Millennium Falcon, lord ... but it has entered an asteroid field, and we cannot risk -- Asteroids do not concern me, Admiral.
...
Ben, tell him I'm -- Ready, are you?
...
- The odds of surviving ... a direct as*ault on an imperial Star Destroyer-- Shut up!
...
Only an overgrown mophead like you would be stupid enough -- I feel terrible.
...
Do you think that after what you did to Han -- - I had no choice.
